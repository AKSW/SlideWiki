...
(function ($, deck, window, undefined) {
	...
	*/
	...
	.bind('deck.change', function(e, from, to) {
		...
		var selected_item=hash.split('#')[1];
		checkLoadStatus(selected_item);
		document.title=$('#'+selected_item+' .slide-title').text().trim();
		//enable iframes
    	$.each($('#'+selected_item+' iframe'),function(index,value){
    		if($(value)[0]._src)
