...
function createArchiveAndDownload()
{
	...
	$.ajax({
			type: 'POST',
			 url: "libraries/frontend/impressionist/server/generateArchive.php",
			 data: {data:previewoutputstring, filename:filename},
			 success: function(msg)
			 {
			 	window.open("libraries/frontend/impressionist/server/download.php?filename="+filename, "_blank");
			 }
	});
}
