<header class="page-header">
	<h1>
		Add new Deck
		<small>
			by uploading slides as .tex
		</small>
	</h1>
</header>

<?php if($user['is_authorized']): ?>
	<form enctype="multipart/form-data" action="./?url=import/handleLATEXUpload" method="POST">
		<div class="clearfix">
			<label for="file">Please choose a file:</label>
			
			<div class="input">
				<input class="input-file" id="file" name="uploaded" type="file" accept="application/zip" />
			</div>
		</div>
