<?php
	...
	class NotifyDaily extends User {
		...
		function __construct() {
                    ...
                    foreach ($users as $user_id) {
                        ...
                        if ($message){
                            $message = '<div style="width:450px; border:1px solid #000;"><div style="padding:5px;color:white; background-color:#345270">SlideWiki news stream for the latest day:</div><div style="padding:5px;">'. $message . '</div></div>';
